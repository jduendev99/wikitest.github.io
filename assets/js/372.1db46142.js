...
/* harmony export */   m: () => (/* binding */ addHtmlLabel)
/* harmony export */ });
/* harmony import */ var _util_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(14620);
...
function addHtmlLabel(root, node) {
  ...
  _util_js__WEBPACK_IMPORTED_MODULE_0__/* .applyStyle */ .Ce(div, node.labelStyle);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Ce: () => (/* binding */ applyStyle),
/* harmony export */   S_: () => (/* binding */ applyClass),
/* harmony export */   cv: () => (/* binding */ isSubgraph),
/* harmony export */   q2: () => (/* binding */ applyTransition),
/* harmony export */   q_: () => (/* binding */ edgeToId)
/* harmony export */ });
/* harmony import */ var lodash_es__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(86012);
/* harmony import */ var lodash_es__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(59680);
...
function applyTransition(selection, g) {
  ...
  if (lodash_es__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .c(graph)) {
    var transition = graph.transition;
    if (lodash_es__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .c(transition)) {
...
var DEFAULT_WEIGHT_FN = constant/* default */.c(1);
...
function greedyFAS(g, weightFn) {
  ...
  // Expand multi-edges
  return flatten/* default */.c(
    map/* default */.c(results, function (e) {
...
function removeNode(g, buckets, zeroIdx, entry, collectPredecessors) {
  ...
  forEach/* default */.c(g.inEdges(entry.v), function (edge) {
  ...
  forEach/* default */.c(g.outEdges(entry.v), function (edge) {
    var weight = g.edge(edge);
    var w = edge.w;
    var wEntry = g.node(w);
    wEntry['in'] -= weight;
...
function buildState(g, weightFn) {
  var fasGraph = new graphlib/* Graph */.M();
  var maxIn = 0;
  var maxOut = 0;

  forEach/* default */.c(g.nodes(), function (v) {
    fasGraph.setNode(v, { v: v, in: 0, out: 0 });
  });

  // Aggregate weights on nodes, but also sum the weights across multi-edges
  // into a single edge for the fasGraph.
  forEach/* default */.c(g.edges(), function (e) {
  ...
  var buckets = range/* default */.c(maxOut + maxIn + 3).map(function () {
    return new List();
  });
  var zeroIdx = maxIn + 1;

  forEach/* default */.c(fasGraph.nodes(), function (v) {
...
function run(g) {
  ...
  forEach/* default */.c(fas, function (e) {
    var label = g.edge(e);
    g.removeEdge(e);
    label.forwardName = e.name;
    label.reversed = true;
    g.setEdge(e.w, e.v, label, uniqueId/* default */.c('rev'));
  });
...
function dfsFAS(g) {
  ...
  function dfs(v) {
    if (has/* default */.c(visited, v)) {
      return;
    }
    visited[v] = true;
    stack[v] = true;
    forEach/* default */.c(g.outEdges(v), function (e) {
      if (has/* default */.c(stack, e.w)) {
        fas.push(e);
      } else {
        dfs(e.w);
      }
...
var merge = __webpack_require__(89064);
// EXTERNAL MODULE: ./node_modules/lodash-es/pick.js + 4 modules
var pick = __webpack_require__(17488);
// EXTERNAL MODULE: ./node_modules/lodash-es/defaults.js
var defaults = __webpack_require__(12804);
...
function baseExtremum(array, iteratee, comparator) {
  ...
  while (++index < length) {
    ...
    if (current != null && (computed === undefined
          ? (current === current && !(0,isSymbol/* default */.c)(current))
...
var identity = __webpack_require__(5816);
...
function max(array) {
  return (array && array.length)
    ? _baseExtremum(array, identity/* default */.c, _baseGt)
    : undefined;
}
...
var _baseAssignValue = __webpack_require__(78848);
// EXTERNAL MODULE: ./node_modules/lodash-es/_baseForOwn.js
var _baseForOwn = __webpack_require__(79985);
// EXTERNAL MODULE: ./node_modules/lodash-es/_baseIteratee.js + 16 modules
var _baseIteratee = __webpack_require__(91312);
...
function mapValues(object, iteratee) {
  var result = {};
  iteratee = (0,_baseIteratee/* default */.c)(iteratee, 3);

  (0,_baseForOwn/* default */.c)(object, function(value, key, object) {
    (0,_baseAssignValue/* default */.c)(result, key, iteratee(value, key, object));
  });
  return result;
}
...
function min(array) {
  return (array && array.length)
    ? _baseExtremum(array, identity/* default */.c, _baseLt)
    : undefined;
}
...
var _root = __webpack_require__(43936);
 ...
 */
var now = function() {
  return _root/* default */.c.Date.now();
};
 ...
 */
function simplify(g) {
  var simplified = new graphlib/* Graph */.M().setGraph(g.graph());
  forEach/* default */.c(g.nodes(), function (v) {
...
function asNonCompoundGraph(g) {
  var simplified = new graphlib/* Graph */.M({ multigraph: g.isMultigraph() }).setGraph(g.graph());
  forEach/* default */.c(g.nodes(), function (v) {
...
function buildLayerMatrix(g) {
  var layering = map/* default */.c(range/* default */.c(util_maxRank(g) + 1), function () {
    return [];
  });
  forEach/* default */.c(g.nodes(), function (v) {
    var node = g.node(v);
    var rank = node.rank;
    if (!isUndefined/* default */.c(rank)) {
...
function normalizeRanks(g) {
  var min = lodash_es_min(
    map/* default */.c(g.nodes(), function (v) {
      return g.node(v).rank;
    })
  );
  forEach/* default */.c(g.nodes(), function (v) {
    var node = g.node(v);
    if (has/* default */.c(node, 'rank')) {
      node.rank -= min;
    }
  });
}
...
function removeEmptyRanks(g) {
  ...
  forEach/* default */.c(layers, function (vs, i) {
    if (isUndefined/* default */.c(vs) && i % nodeRankFactor !== 0) {
      --delta;
    } else if (delta) {
      forEach/* default */.c(vs, function (v) {
        g.node(v).rank += delta;
      });
    }
  });
...
function partition(collection, fn) {
  var result = { lhs: [], rhs: [] };
  forEach/* default */.c(collection, function (value) {
    if (fn(value)) {
...
function addBorderSegments(g) {
  function dfs(v) {
    ...
    var node = g.node(v);
    if (children.length) {
      forEach/* default */.c(children, dfs);
    }

    if (has/* default */.c(node, 'minRank')) {
      node.borderLeft = [];
      node.borderRight = [];
  ...
  forEach/* default */.c(g.children(), dfs);
}
...
function reverseY(g) {
  ...
  forEach/* default */.c(g.edges(), function (e) {
    var edge = g.edge(e);
    forEach/* default */.c(edge.points, reverseYOne);
    if (has/* default */.c(edge, 'y')) {
      reverseYOne(edge);
    }
  });
}
...
function swapXY(g) {
  ...
  forEach/* default */.c(g.edges(), function (e) {
    var edge = g.edge(e);
    forEach/* default */.c(edge.points, swapXYOne);
    if (has/* default */.c(edge, 'x')) {
      swapXYOne(edge);
    }
  });
}
...
function normalize_run(g) {
  g.graph().dummyChains = [];
  forEach/* default */.c(g.edges(), function (edge) {
...
function normalize_undo(g) {
  forEach/* default */.c(g.graph().dummyChains, function (v) {
    var node = g.node(v);
...
function minBy(array, iteratee) {
  return (array && array.length)
    ? _baseExtremum(array, (0,_baseIteratee/* default */.c)(iteratee, 2), _baseLt)
    : undefined;
}
...
function longestPath(g) {
  ...
  function dfs(v) {
    ...
    var rank = lodash_es_min(
      map/* default */.c(g.outEdges(v), function (e) {
...
function feasibleTree(g) {
  var t = new graphlib/* Graph */.M({ directed: false });
...
function tightTree(t, g) {
  function dfs(v) {
    forEach/* default */.c(g.nodeEdges(v), function (e) {
      var edgeV = e.v,
        w = v === edgeV ? e.w : edgeV;
...
function shiftRanks(t, g, delta) {
  forEach/* default */.c(t.nodes(), function (v) {
    g.node(v).rank += delta;
  });
}

// EXTERNAL MODULE: ./node_modules/lodash-es/isArrayLike.js
var isArrayLike = __webpack_require__(42440);
// EXTERNAL MODULE: ./node_modules/lodash-es/keys.js
var keys = __webpack_require__(62420);
...
function createFind(findIndexFunc) {
  return function(collection, predicate, fromIndex) {
    ...
    if (!(0,isArrayLike/* default */.c)(collection)) {
      var iteratee = (0,_baseIteratee/* default */.c)(predicate, 3);
      collection = (0,keys/* default */.c)(collection);
...
var _baseFindIndex = __webpack_require__(16428);
// EXTERNAL MODULE: ./node_modules/lodash-es/toFinite.js + 3 modules
var toFinite = __webpack_require__(70020);
...
function toInteger(value) {
  var result = (0,toFinite/* default */.c)(value),
      remainder = result % 1;
...
function findIndex(array, predicate, fromIndex) {
  ...
  return (0,_baseFindIndex/* default */.c)(array, (0,_baseIteratee/* default */.c)(predicate, 3), index);
}
...
var filter = __webpack_require__(55720);
...
var DEFAULT_WEIGHT_FUNC = constant/* default */.c(1);
...
var floyd_warshall_DEFAULT_WEIGHT_FUNC = constant/* default */.c(1);
...
var _getTag = __webpack_require__(17188);
// EXTERNAL MODULE: ./node_modules/lodash-es/_baseGetTag.js + 2 modules
var _baseGetTag = __webpack_require__(67724);
// EXTERNAL MODULE: ./node_modules/lodash-es/isArray.js
var isArray = __webpack_require__(78820);
// EXTERNAL MODULE: ./node_modules/lodash-es/isObjectLike.js
var isObjectLike = __webpack_require__(23584);
...
function isString(value) {
  return typeof value == 'string' ||
    (!(0,isArray/* default */.c)(value) && (0,isObjectLike/* default */.c)(value) && (0,_baseGetTag/* default */.c)(value) == stringTag);
}

/* harmony default export */ const lodash_es_isString = (isString);

// EXTERNAL MODULE: ./node_modules/lodash-es/_baseProperty.js
var _baseProperty = __webpack_require__(60472);
 ...
 */
var asciiSize = (0,_baseProperty/* default */.c)('length');
...
function size(collection) {
  ...
  var tag = (0,_getTag/* default */.c)(collection);
  if (tag == mapTag || tag == setTag) {
    return collection.size;
  }
  return (0,_baseKeys/* default */.c)(collection).length;
}
...
function topsort_topsort(g) {
  ...
  function visit(node) {
    if (has/* default */.c(stack, node)) {
      throw new topsort_CycleException();
    }

    if (!has/* default */.c(visited, node)) {
      stack[node] = true;
      visited[node] = true;
      forEach/* default */.c(g.predecessors(node), visit);
      delete stack[node];
      results.push(node);
    }
  }

  forEach/* default */.c(g.sinks(), visit);
...
function doDfs(g, v, postorder, visited, navigation, acc) {
  if (!has/* default */.c(visited, v)) {
    ...
    forEach/* default */.c(navigation(v), function (w) {
...
var graph = __webpack_require__(58048);
...
function calcCutValue(t, g, child) {
  ...
  forEach/* default */.c(g.nodeEdges(child), function (e) {
...
function dfsAssignLowLim(tree, visited, nextLim, v, parent) {
  ...
  visited[v] = true;
  forEach/* default */.c(tree.neighbors(v), function (w) {
    if (!has/* default */.c(visited, w)) {
...
function enterEdge(t, g, edge) {
  ...
  var candidates = filter/* default */.c(g.edges(), function (edge) {
    return (
...
var reduce = __webpack_require__(90460);
...
function nesting_graph_run(g) {
  ...
  var height = lodash_es_max(values/* default */.c(depths)) - 1; // Note: depths is an Object not an array
  ...
  forEach/* default */.c(g.children(), function (child) {
...
function nesting_graph_dfs(g, root, nodeSep, weight, height, depths, v) {
  ...
  forEach/* default */.c(children, function (child) {
    nesting_graph_dfs(g, root, nodeSep, weight, height, depths, child);
...
function treeDepths(g) {
  ...
  forEach/* default */.c(g.children(), function (v) {
    dfs(v, 1);
  });
  return depths;
}
...
var _baseClone = __webpack_require__(48492);
...
function cloneDeep(value) {
  return (0,_baseClone/* default */.c)(value, CLONE_DEEP_FLAG | CLONE_SYMBOLS_FLAG);
}
...
function buildLayerGraph(g, rank, relationship) {
  var root = createRootNode(g),
    result = new graphlib/* Graph */.M({ compound: true })
      .setGraph({ root: root })
  ...
  forEach/* default */.c(g.nodes(), function (v) {
    ...
    if (node.rank === rank || (node.minRank <= rank && rank <= node.maxRank)) {
      ...
      forEach/* default */.c(g[relationship](v), function (e) {
        var u = e.v === v ? e.w : e.v,
          edge = result.edge(u, v),
          weight = !isUndefined/* default */.c(edge) ? edge.weight : 0;
...
function createRootNode(g) {
  var v;
  while (g.hasNode((v = uniqueId/* default */.c('_root'))));
  return v;
}

// EXTERNAL MODULE: ./node_modules/lodash-es/_assignValue.js
var _assignValue = __webpack_require__(77412);
...
function zipObject(props, values) {
  return _baseZipObject(props || [], values || [], _assignValue/* default */.c);
}
...
var _arrayMap = __webpack_require__(1304);
// EXTERNAL MODULE: ./node_modules/lodash-es/_baseGet.js
var _baseGet = __webpack_require__(60604);
// EXTERNAL MODULE: ./node_modules/lodash-es/_baseMap.js
var _baseMap = __webpack_require__(90360);
...
var _baseUnary = __webpack_require__(71180);
...
function compareAscending(value, other) {
  if (value !== other) {
    var valIsDefined = value !== undefined,
        ...
        valIsSymbol = (0,isSymbol/* default */.c)(value);

    var othIsDefined = other !== undefined,
        othIsNull = other === null,
        othIsReflexive = other === other,
        othIsSymbol = (0,isSymbol/* default */.c)(other);
...
function baseOrderBy(collection, iteratees, orders) {
  if (iteratees.length) {
    iteratees = (0,_arrayMap/* default */.c)(iteratees, function(iteratee) {
      if ((0,isArray/* default */.c)(iteratee)) {
        return function(value) {
          return (0,_baseGet/* default */.c)(value, iteratee.length === 1 ? iteratee[0] : iteratee);
        }
      }
      return iteratee;
    });
  } else {
    iteratees = [identity/* default */.c];
  }

  var index = -1;
  iteratees = (0,_arrayMap/* default */.c)(iteratees, (0,_baseUnary/* default */.c)(_baseIteratee/* default */.c));

  var result = (0,_baseMap/* default */.c)(collection, function(value, key, collection) {
    var criteria = (0,_arrayMap/* default */.c)(iteratees, function(iteratee) {
...
var _isIterateeCall = __webpack_require__(15552);
 ...
 */
var sortBy = (0,_baseRest/* default */.c)(function(collection, iteratees) {
  if (collection == null) {
    return [];
  }
  var length = iteratees.length;
  if (length > 1 && (0,_isIterateeCall/* default */.c)(collection, iteratees[0], iteratees[1])) {
    iteratees = [];
  } else if (length > 2 && (0,_isIterateeCall/* default */.c)(iteratees[0], iteratees[1], iteratees[2])) {
    iteratees = [iteratees[0]];
  }
  return _baseOrderBy(collection, (0,_baseFlatten/* default */.c)(iteratees, 1), []);
});
...
function twoLayerCrossCount(g, northLayer, southLayer) {
  ...
  var southPos = lodash_es_zipObject(
    southLayer,
    map/* default */.c(southLayer, function (v, i) {
      return i;
    })
  );
  var southEntries = flatten/* default */.c(
    map/* default */.c(northLayer, function (v) {
  ...
  firstIndex -= 1;
  var tree = map/* default */.c(new Array(treeSize), function () {
    return 0;
  });
...
function initOrder(g) {
  var visited = {};
  var simpleNodes = filter/* default */.c(g.nodes(), function (v) {
    return !g.children(v).length;
  });
  var maxRank = lodash_es_max(
    map/* default */.c(simpleNodes, function (v) {
      return g.node(v).rank;
    })
  );
  var layers = map/* default */.c(range/* default */.c(maxRank + 1), function () {
    return [];
  });

  function dfs(v) {
    if (has/* default */.c(visited, v)) return;
    visited[v] = true;
    var node = g.node(v);
    layers[node.rank].push(v);
    forEach/* default */.c(g.successors(v), dfs);
  }

  var orderedVs = lodash_es_sortBy(simpleNodes, function (v) {
    return g.node(v).rank;
  });
  forEach/* default */.c(orderedVs, dfs);
...
function barycenter(g, movable) {
  return map/* default */.c(movable, function (v) {
    var inV = g.inEdges(v);
    if (!inV.length) {
      return { v: v };
    } else {
      var result = reduce/* default */.c(
        inV,
        function (acc, e) {
          var edge = g.edge(e),
            nodeU = g.node(e.v);
...
function resolveConflicts(entries, cg) {
  var mappedEntries = {};
  forEach/* default */.c(entries, function (entry, i) {
    ...
    if (!isUndefined/* default */.c(entry.barycenter)) {
      // @ts-expect-error
  ...
  forEach/* default */.c(cg.edges(), function (e) {
    var entryV = mappedEntries[e.v];
    var entryW = mappedEntries[e.w];
    if (!isUndefined/* default */.c(entryV) && !isUndefined/* default */.c(entryW)) {
      entryW.indegree++;
      entryV.out.push(mappedEntries[e.w]);
    }
  });

  var sourceSet = filter/* default */.c(mappedEntries, function (entry) {
    // @ts-expect-error
...
function doResolveConflicts(sourceSet) {
  ...
  function handleIn(vEntry) {
    return function (uEntry) {
      ...
      if (
        isUndefined/* default */.c(uEntry.barycenter) ||
        isUndefined/* default */.c(vEntry.barycenter) ||
  ...
  while (sourceSet.length) {
    ...
    entries.push(entry);
    forEach/* default */.c(entry['in'].reverse(), handleIn(entry));
    forEach/* default */.c(entry.out, handleOut(entry));
  }

  return map/* default */.c(
    filter/* default */.c(entries, function (entry) {
      return !entry.merged;
    }),
    function (entry) {
      return pick/* default */.c(entry, ['vs', 'i', 'barycenter', 'weight']);
    }
  );
}
...
function sort(entries, biasRight) {
  var parts = partition(entries, function (entry) {
    return has/* default */.c(entry, 'barycenter');
  });
  ...
  forEach/* default */.c(sortable, function (entry) {
  ...
  var result = { vs: flatten/* default */.c(vs) };
  if (weight) {
...
function sortSubgraph(g, v, cg, biasRight) {
  ...
  if (bl) {
    movable = filter/* default */.c(movable, function (w) {
      return w !== bl && w !== br;
    });
  }

  var barycenters = barycenter(g, movable);
  forEach/* default */.c(barycenters, function (entry) {
    if (g.children(entry.v).length) {
      var subgraphResult = sortSubgraph(g, entry.v, cg, biasRight);
      subgraphs[entry.v] = subgraphResult;
      if (has/* default */.c(subgraphResult, 'barycenter')) {
  ...
  if (bl) {
    result.vs = flatten/* default */.c([bl, result.vs, br]);
    if (g.predecessors(bl).length) {
      var blPred = g.node(g.predecessors(bl)[0]),
        brPred = g.node(g.predecessors(br)[0]);
      if (!has/* default */.c(result, 'barycenter')) {
        result.barycenter = 0;
        result.weight = 0;
      }
      result.barycenter =
...
function expandSubgraphs(entries, subgraphs) {
  forEach/* default */.c(entries, function (entry) {
    entry.vs = flatten/* default */.c(
...
function mergeBarycenters(target, other) {
  if (!isUndefined/* default */.c(target.barycenter)) {
    target.barycenter =
...
function order(g) {
  var maxRank = util_maxRank(g),
    downLayerGraphs = buildLayerGraphs(g, range/* default */.c(1, maxRank + 1), 'inEdges'),
    upLayerGraphs = buildLayerGraphs(g, range/* default */.c(maxRank - 1, -1, -1), 'outEdges');
...
function buildLayerGraphs(g, ranks, relationship) {
  return map/* default */.c(ranks, function (rank) {
    return buildLayerGraph(g, rank, relationship);
  });
}

function sweepLayerGraphs(layerGraphs, biasRight) {
  var cg = new graphlib/* Graph */.M();
  forEach/* default */.c(layerGraphs, function (lg) {
    var root = lg.graph().root;
    var sorted = sortSubgraph(lg, root, cg, biasRight);
    forEach/* default */.c(sorted.vs, function (v, i) {
      lg.node(v).order = i;
    });
...
function assignOrder(g, layering) {
  forEach/* default */.c(layering, function (layer) {
    forEach/* default */.c(layer, function (v, i) {
      g.node(v).order = i;
    });
  });
}
...
function parent_dummy_chains_postorder(g) {
  ...
  function dfs(v) {
    var low = lim;
    forEach/* default */.c(g.children(v), dfs);
...
var _castFunction = __webpack_require__(12176);
...
function forIn(object, iteratee) {
  return object == null
    ? object
    : (0,_baseFor/* default */.c)(object, (0,_castFunction/* default */.c)(iteratee), keysIn/* default */.c);
}
...
function findType1Conflicts(g, layering) {
  ...
  function visitLayer(prevLayer, layer) {
    ...
    forEach/* default */.c(layer, function (v, i) {
      ...
      if (w || v === lastNode) {
        forEach/* default */.c(layer.slice(scanPos, i + 1), function (scanNode) {
          forEach/* default */.c(g.predecessors(scanNode), function (u) {
            var uLabel = g.node(u),
              uPos = uLabel.order;
  ...
  reduce/* default */.c(layering, visitLayer);
  return conflicts;
}
...
function findType2Conflicts(g, layering) {
  ...
  function scan(south, southPos, southEnd, prevNorthBorder, nextNorthBorder) {
    var v;
    forEach/* default */.c(range/* default */.c(southPos, southEnd), function (i) {
      v = south[i];
      if (g.node(v).dummy) {
        forEach/* default */.c(g.predecessors(v), function (u) {
          var uNode = g.node(u);
  ...
  function visitLayer(north, south) {
    ...
    forEach/* default */.c(south, function (v, southLookahead) {
...
function hasConflict(conflicts, v, w) {
  ...
  return has/* default */.c(conflicts[v], w);
}
...
function verticalAlignment(g, layering, conflicts, neighborFn) {
  ...
  forEach/* default */.c(layering, function (layer) {
    forEach/* default */.c(layer, function (v, order) {
      root[v] = v;
      align[v] = v;
      pos[v] = order;
    });
  ...
  forEach/* default */.c(layering, function (layer) {
    var prevIdx = -1;
    forEach/* default */.c(layer, function (v) {
      var ws = neighborFn(v);
      if (ws.length) {
...
function horizontalCompaction(g, layering, root, align, reverseSep) {
  ...
  forEach/* default */.c(align, function (v) {
    xs[v] = xs[root[v]];
  });
...
function buildBlockGraph(g, layering, root, reverseSep) {
  var blockGraph = new graphlib/* Graph */.M(),
    graphLabel = g.graph(),
...
function findSmallestWidthAlignment(g, xss) {
  return lodash_es_minBy(values/* default */.c(xss), function (xs) {
...
function alignCoordinates(xss, alignTo) {
  var alignToVals = values/* default */.c(alignTo),
    alignToMin = lodash_es_min(alignToVals),
    alignToMax = lodash_es_max(alignToVals);

  forEach/* default */.c(['u', 'd'], function (vert) {
    forEach/* default */.c(['l', 'r'], function (horiz) {
      var alignment = vert + horiz,
        xs = xss[alignment],
        delta;
      if (xs === alignTo) return;

      var xsVals = values/* default */.c(xs);
...
function balance(xss, align) {
  return lodash_es_mapValues(xss.ul, function (ignore, v) {
    if (align) {
      ...
      var xs = lodash_es_sortBy(map/* default */.c(xss, v));
      return (xs[1] + xs[2]) / 2;
    }
  });
}
...
function positionX(g) {
  ...
  var conflicts = merge/* default */.c(findType1Conflicts(g, layering), findType2Conflicts(g, layering));

  var xss = {};
  var adjustedLayering;
  forEach/* default */.c(['u', 'd'], function (vert) {
    adjustedLayering = vert === 'u' ? layering : values/* default */.c(layering).reverse();
    forEach/* default */.c(['l', 'r'], function (horiz) {
      if (horiz === 'r') {
        adjustedLayering = map/* default */.c(adjustedLayering, function (inner) {
          return values/* default */.c(inner).reverse();
        });
      }
...
function sep(nodeSep, edgeSep, reverseSep) {
  return function (g, v, w) {
    ...
    sum += vLabel.width / 2;
    if (has/* default */.c(vLabel, 'labelpos')) {
    ...
    sum += wLabel.width / 2;
    if (has/* default */.c(wLabel, 'labelpos')) {
...
function positionY(g) {
  ...
  forEach/* default */.c(layering, function (layer) {
    var maxHeight = lodash_es_max(
      map/* default */.c(layer, function (v) {
...
function updateInputGraph(inputGraph, layoutGraph) {
  forEach/* default */.c(inputGraph.nodes(), function (v) {
  ...
  forEach/* default */.c(inputGraph.edges(), function (e) {
    var inputLabel = inputGraph.edge(e);
    var layoutLabel = layoutGraph.edge(e);

    inputLabel.points = layoutLabel.points;
    if (has/* default */.c(layoutLabel, 'x')) {
      inputLabel.x = layoutLabel.x;
      inputLabel.y = layoutLabel.y;
    }
  });
...
function buildLayoutGraph(inputGraph) {
  var g = new graphlib/* Graph */.M({ multigraph: true, compound: true });
  var graph = canonicalize(inputGraph.graph());

  g.setGraph(
    merge/* default */.c({}, graphDefaults, selectNumberAttrs(graph, graphNumAttrs), pick/* default */.c(graph, graphAttrs))
  );

  forEach/* default */.c(inputGraph.nodes(), function (v) {
    var node = canonicalize(inputGraph.node(v));
    g.setNode(v, defaults/* default */.c(selectNumberAttrs(node, nodeNumAttrs), nodeDefaults));
  ...
  forEach/* default */.c(inputGraph.edges(), function (e) {
    ...
    g.setEdge(
      e,
      merge/* default */.c({}, edgeDefaults, selectNumberAttrs(edge, edgeNumAttrs), pick/* default */.c(edge, edgeAttrs))
    );
  });
...
function translateGraph(g) {
  ...
  forEach/* default */.c(g.edges(), function (e) {
    var edge = g.edge(e);
    forEach/* default */.c(edge.points, function (p) {
      p.x -= minX;
      p.y -= minY;
    });
    if (has/* default */.c(edge, 'x')) {
...
function insertSelfEdges(g) {
  ...
  forEach/* default */.c(layers, function (layer) {
    var orderShift = 0;
    forEach/* default */.c(layer, function (v, i) {
      var node = g.node(v);
      node.order = i + orderShift;
      forEach/* default */.c(node.selfEdges, function (selfEdge) {
        addDummyNode(
          g,
          'selfedge',
          {
...
function selectNumberAttrs(obj, attrs) {
  return lodash_es_mapValues(pick/* default */.c(obj, attrs), Number);
}

function canonicalize(attrs) {
  var newAttrs = {};
  forEach/* default */.c(attrs, function (v, k) {
...
var isFunction = __webpack_require__(59680);
// EXTERNAL MODULE: ./node_modules/lodash-es/keys.js
var keys = __webpack_require__(62420);
// EXTERNAL MODULE: ./node_modules/lodash-es/filter.js + 1 modules
var filter = __webpack_require__(55720);
// EXTERNAL MODULE: ./node_modules/lodash-es/isEmpty.js
var isEmpty = __webpack_require__(28796);
// EXTERNAL MODULE: ./node_modules/lodash-es/forEach.js
var forEach = __webpack_require__(50080);
// EXTERNAL MODULE: ./node_modules/lodash-es/isUndefined.js
var isUndefined = __webpack_require__(60372);
...
var _SetCache = __webpack_require__(34528);
// EXTERNAL MODULE: ./node_modules/lodash-es/_baseFindIndex.js
var _baseFindIndex = __webpack_require__(16428);
...
function baseIndexOf(array, value, fromIndex) {
  return value === value
    ...
    : (0,_baseFindIndex/* default */.c)(array, _baseIsNaN, fromIndex);
}
...
var _cacheHas = __webpack_require__(5960);
// EXTERNAL MODULE: ./node_modules/lodash-es/_Set.js
var _Set = __webpack_require__(61268);
 ...
 */
var createSet = !(_Set/* default */.c && (1 / (0,_setToArray/* default */.c)(new _Set/* default */.c([,-0]))[1]) == INFINITY) ? lodash_es_noop : function(values) {
  return new _Set/* default */.c(values);
};
...
function baseUniq(array, iteratee, comparator) {
  ...
  if (comparator) {
    ...
    if (set) {
      return (0,_setToArray/* default */.c)(set);
    }
    isCommon = false;
    includes = _cacheHas/* default */.c;
    seen = new _SetCache/* default */.c;
  }
  else {
...
var isArrayLikeObject = __webpack_require__(19724);
 ...
 * // => [2, 1]
 */
var union = (0,_baseRest/* default */.c)(function(arrays) {
  return _baseUniq((0,_baseFlatten/* default */.c)(arrays, 1, isArrayLikeObject/* default */.c, true));
});
...
class Graph {
  constructor(opts = {}) {
    this._isDirected = has/* default */.c(opts, 'directed') ? opts.directed : true;
    this._isMultigraph = has/* default */.c(opts, 'multigraph') ? opts.multigraph : false;
    this._isCompound = has/* default */.c(opts, 'compound') ? opts.compound : false;

    // Label for the graph itself
    this._label = undefined;

    // Defaults to be set when creating a new node
    this._defaultNodeLabelFn = constant/* default */.c(undefined);

    // Defaults to be set when creating a new edge
    this._defaultEdgeLabelFn = constant/* default */.c(undefined);
  ...
  setDefaultNodeLabel(newDefault) {
    if (!isFunction/* default */.c(newDefault)) {
      newDefault = constant/* default */.c(newDefault);
    }
  ...
  nodes() {
    return keys/* default */.c(this._nodes);
  }
  sources() {
    var self = this;
    return filter/* default */.c(this.nodes(), function (v) {
      return isEmpty/* default */.c(self._in[v]);
    });
  }
  sinks() {
    var self = this;
    return filter/* default */.c(this.nodes(), function (v) {
      return isEmpty/* default */.c(self._out[v]);
    });
  }
  setNodes(vs, value) {
    var args = arguments;
  ...
  setNode(v, value) {
    if (has/* default */.c(this._nodes, v)) {
  ...
  hasNode(v) {
    return has/* default */.c(this._nodes, v);
  }
  removeNode(v) {
    var self = this;
    if (has/* default */.c(this._nodes, v)) {
      ...
      if (this._isCompound) {
        ...
        forEach/* default */.c(this.children(v), function (child) {
          self.setParent(child);
        });
        delete this._children[v];
      }
      forEach/* default */.c(keys/* default */.c(this._in[v]), removeEdge);
      delete this._in[v];
      delete this._preds[v];
      forEach/* default */.c(keys/* default */.c(this._out[v]), removeEdge);
      delete this._out[v];
      delete this._sucs[v];
      --this._nodeCount;
    }
  ...
  setParent(v, parent) {
    ...
    if (isUndefined/* default */.c(parent)) {
      parent = GRAPH_NODE;
    } else {
      // Coerce parent to string
      parent += '';
      for (var ancestor = parent; !isUndefined/* default */.c(ancestor); ancestor = this.parent(ancestor)) {
        if (ancestor === v) {
  ...
  children(v) {
    ...
    if (this._isCompound) {
      ...
      if (children) {
        return keys/* default */.c(children);
      }
  ...
  predecessors(v) {
    ...
    if (predsV) {
      return keys/* default */.c(predsV);
    }
  }
  successors(v) {
    var sucsV = this._sucs[v];
    if (sucsV) {
      return keys/* default */.c(sucsV);
    }
  }
  neighbors(v) {
  ...
  filterNodes(filter) {
    ...
    var self = this;
    forEach/* default */.c(this._nodes, function (value, v) {
      if (filter(v)) {
        copy.setNode(v, value);
      }
    });

    forEach/* default */.c(this._edgeObjs, function (e) {
      // @ts-expect-error
    ...
    if (this._isCompound) {
      forEach/* default */.c(copy.nodes(), function (v) {
  ...
  edges() {
    return values/* default */.c(this._edgeObjs);
  }
  setPath(vs, value) {
    var self = this;
    var args = arguments;
    reduce/* default */.c(vs, function (v, w) {
      if (args.length > 1) {
  ...
  setEdge() {
    ...
    v = '' + v;
    w = '' + w;
    if (!isUndefined/* default */.c(name)) {
      name = '' + name;
    }

    var e = edgeArgsToId(this._isDirected, v, w, name);
    if (has/* default */.c(this._edgeLabels, e)) {
      if (valueSpecified) {
    ...
    if (!isUndefined/* default */.c(name) && !this._isMultigraph) {
  ...
  hasEdge(v, w, name) {
    var e =
      arguments.length === 1
        ? edgeObjToId(this._isDirected, arguments[0])
        : edgeArgsToId(this._isDirected, v, w, name);
    return has/* default */.c(this._edgeLabels, e);
  }
  removeEdge(v, w, name) {
    var e =
      arguments.length === 1
  ...
  inEdges(v, u) {
    var inV = this._in[v];
    if (inV) {
      var edges = values/* default */.c(inV);
      if (!u) {
        return edges;
      }
      return filter/* default */.c(edges, function (edge) {
        return edge.v === u;
      });
    }
  }
  outEdges(v, w) {
    ...
    if (outV) {
      var edges = values/* default */.c(outV);
      if (!w) {
        return edges;
      }
      return filter/* default */.c(edges, function (edge) {
...
function edgeArgsToId(isDirected, v_, w_, name) {
  ...
  return v + EDGE_KEY_DELIM + w + EDGE_KEY_DELIM + (isUndefined/* default */.c(name) ? DEFAULT_EDGE_NAME : name);
}
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   M: () => (/* reexport safe */ _graph_js__WEBPACK_IMPORTED_MODULE_0__.M)
/* harmony export */ });
/* unused harmony export version */
/* harmony import */ var _graph_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(58048);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   G: () => (/* binding */ write)
/* harmony export */ });
/* unused harmony export read */
/* harmony import */ var lodash_es__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(60372);
/* harmony import */ var lodash_es__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(77784);
/* harmony import */ var lodash_es__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(92696);
/* harmony import */ var _graph_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(58048);
...
function write(g) {
  ...
  if (!lodash_es__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .c(g.graph())) {
    json.value = lodash_es__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .c(g.graph());
  }
  return json;
}

function writeNodes(g) {
  return lodash_es__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .c(g.nodes(), function (v) {
    var nodeValue = g.node(v);
    var parent = g.parent(v);
    var node = { v: v };
    if (!lodash_es__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .c(nodeValue)) {
      node.value = nodeValue;
    }
    if (!lodash_es__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .c(parent)) {
      node.parent = parent;
    }
    return node;
  });
...
function writeEdges(g) {
  return lodash_es__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .c(g.edges(), function (e) {
    var edgeValue = g.edge(e);
    var edge = { v: e.v, w: e.w };
    if (!lodash_es__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .c(e.name)) {
      edge.name = e.name;
    }
    if (!lodash_es__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .c(edgeValue)) {
...
/* harmony export */ });
/* harmony import */ var _utils_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(89612);
/* harmony import */ var _color_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(72120);
/* IMPORT */


/* MAIN */
const channel = (color, channel) => {
    return _utils_index_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .c.lang.round(_color_index_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .c.parse(color)[channel]);
};
/* EXPORT */
...
var _MapCache = __webpack_require__(86320);
...
function SetCache(values) {
  ...
  this.__data__ = new _MapCache/* default */.c;
  while (++index < length) {
...
function baseAssign(object, source) {
  return object && (0,_copyObject/* default */.c)(source, (0,keys/* default */.c)(source), object);
}
...
function baseAssignIn(object, source) {
  return object && (0,_copyObject/* default */.c)(source, (0,keysIn/* default */.c)(source), object);
}

/* harmony default export */ const _baseAssignIn = (baseAssignIn);

// EXTERNAL MODULE: ./node_modules/lodash-es/_cloneBuffer.js
var _cloneBuffer = __webpack_require__(86656);
// EXTERNAL MODULE: ./node_modules/lodash-es/_copyArray.js
var _copyArray = __webpack_require__(32488);
// EXTERNAL MODULE: ./node_modules/lodash-es/_getSymbols.js
var _getSymbols = __webpack_require__(10772);
...
function copySymbols(source, object) {
  return (0,_copyObject/* default */.c)(source, (0,_getSymbols/* default */.c)(source), object);
}

/* harmony default export */ const _copySymbols = (copySymbols);

// EXTERNAL MODULE: ./node_modules/lodash-es/_arrayPush.js
var _arrayPush = __webpack_require__(25072);
// EXTERNAL MODULE: ./node_modules/lodash-es/_getPrototype.js
var _getPrototype = __webpack_require__(75388);
// EXTERNAL MODULE: ./node_modules/lodash-es/stubArray.js
var stubArray = __webpack_require__(41716);
 ...
 */
var getSymbolsIn = !nativeGetSymbols ? stubArray/* default */.c : function(object) {
  var result = [];
  while (object) {
    (0,_arrayPush/* default */.c)(result, (0,_getSymbols/* default */.c)(object));
    object = (0,_getPrototype/* default */.c)(object);
  }
  return result;
};
...
function copySymbolsIn(source, object) {
  return (0,_copyObject/* default */.c)(source, _getSymbolsIn(source), object);
}

/* harmony default export */ const _copySymbolsIn = (copySymbolsIn);

// EXTERNAL MODULE: ./node_modules/lodash-es/_getAllKeys.js
var _getAllKeys = __webpack_require__(22980);
// EXTERNAL MODULE: ./node_modules/lodash-es/_baseGetAllKeys.js
var _baseGetAllKeys = __webpack_require__(30176);
...
function getAllKeysIn(object) {
  return (0,_baseGetAllKeys/* default */.c)(object, keysIn/* default */.c, _getSymbolsIn);
}
...
var _cloneArrayBuffer = __webpack_require__(40976);
...
function cloneDataView(dataView, isDeep) {
  var buffer = isDeep ? (0,_cloneArrayBuffer/* default */.c)(dataView.buffer) : dataView.buffer;
...
var _Symbol = __webpack_require__(24048);
;// CONCATENATED MODULE: ./node_modules/lodash-es/_cloneSymbol.js


/** Used to convert symbols to primitives and strings. */
var symbolProto = _Symbol/* default */.c ? _Symbol/* default */.c.prototype : undefined,
...
var _cloneTypedArray = __webpack_require__(70552);
...
function initCloneByTag(object, tag, isDeep) {
  ...
  switch (tag) {
    case arrayBufferTag:
      return (0,_cloneArrayBuffer/* default */.c)(object);
    ...
    case uint8Tag: case uint8ClampedTag: case uint16Tag: case uint32Tag:
      return (0,_cloneTypedArray/* default */.c)(object, isDeep);
...
var _initCloneObject = __webpack_require__(1684);
// EXTERNAL MODULE: ./node_modules/lodash-es/isArray.js
var isArray = __webpack_require__(78820);
// EXTERNAL MODULE: ./node_modules/lodash-es/isBuffer.js + 1 modules
var isBuffer = __webpack_require__(57274);
// EXTERNAL MODULE: ./node_modules/lodash-es/isObjectLike.js
var isObjectLike = __webpack_require__(23584);
...
function baseIsMap(value) {
  return (0,isObjectLike/* default */.c)(value) && (0,_getTag/* default */.c)(value) == _baseIsMap_mapTag;
}
...
var _nodeUtil = __webpack_require__(17576);
...
var nodeIsMap = _nodeUtil/* default */.c && _nodeUtil/* default */.c.isMap;
 ...
 * // => false
 */
var isMap = nodeIsMap ? (0,_baseUnary/* default */.c)(nodeIsMap) : _baseIsMap;

/* harmony default export */ const lodash_es_isMap = (isMap);

// EXTERNAL MODULE: ./node_modules/lodash-es/isObject.js
var isObject = __webpack_require__(5368);
...
function baseIsSet(value) {
  return (0,isObjectLike/* default */.c)(value) && (0,_getTag/* default */.c)(value) == _baseIsSet_setTag;
}
...
/* Node.js helper references. */
var nodeIsSet = _nodeUtil/* default */.c && _nodeUtil/* default */.c.isSet;
 ...
 * // => false
 */
var isSet = nodeIsSet ? (0,_baseUnary/* default */.c)(nodeIsSet) : _baseIsSet;
...
function baseClone(value, bitmask, customizer, key, object, stack) {
  ...
  if (!(0,isObject/* default */.c)(value)) {
    return value;
  }
  var isArr = (0,isArray/* default */.c)(value);
  if (isArr) {
    result = _initCloneArray(value);
    if (!isDeep) {
      return (0,_copyArray/* default */.c)(value, result);
    }
  } else {
    var tag = (0,_getTag/* default */.c)(value),
        isFunc = tag == funcTag || tag == genTag;

    if ((0,isBuffer/* default */.c)(value)) {
      return (0,_cloneBuffer/* default */.c)(value, isDeep);
    }
    if (tag == objectTag || tag == argsTag || (isFunc && !object)) {
      result = (isFlat || isFunc) ? {} : (0,_initCloneObject/* default */.c)(value);
      if (!isDeep) {
        return isFlat
  ...
  stack || (stack = new _Stack/* default */.c);
  ...
  var keysFunc = isFull
    ? (isFlat ? _getAllKeysIn : _getAllKeys/* default */.c)
    : (isFlat ? keysIn/* default */.c : keys/* default */.c);

  var props = isArr ? undefined : keysFunc(value);
  (0,_arrayEach/* default */.c)(props || value, function(subValue, key) {
    if (props) {
      key = subValue;
      subValue = value[key];
    }
    // Recursively populate clone (susceptible to call stack limits).
    (0,_assignValue/* default */.c)(result, key, baseClone(subValue, bitmask, customizer, key, value, stack));
  });
  return result;
}
 ...
 */
var baseEach = _createBaseEach(_baseForOwn/* default */.c);
...
var isArguments = __webpack_require__(59636);
// EXTERNAL MODULE: ./node_modules/lodash-es/isArray.js
var isArray = __webpack_require__(78820);
...
var spreadableSymbol = _Symbol/* default */.c ? _Symbol/* default */.c.isConcatSpreadable : undefined;
...
function isFlattenable(value) {
  return (0,isArray/* default */.c)(value) || (0,isArguments/* default */.c)(value) ||
  ...
  while (++index < length) {
    ...
    if (depth > 0 && predicate(value)) {
      if (depth > 1) {
        ...
        (0,_arrayPush/* default */.c)(result, value);
      }
    } else if (!isStrict) {
...
/* harmony export */   c: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _baseFor_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(19004);
/* harmony import */ var _keys_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(62420);
...
function baseForOwn(object, iteratee) {
  return object && (0,_baseFor_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .c)(object, iteratee, _keys_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .c);
}
...
/* harmony export */   c: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _castPath_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(58356);
/* harmony import */ var _toKey_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(32128);
...
function baseGet(object, path) {
  path = (0,_castPath_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .c)(path, object);

  var index = 0,
      length = path.length;

  while (object != null && index < length) {
    object = object[(0,_toKey_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .c)(path[index++])];
  }
...
/* harmony export */   c: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _arrayPush_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(25072);
...
function baseGetAllKeys(object, keysFunc, symbolsFunc) {
  ...
  return (0,_isArray_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .c)(object) ? result : (0,_arrayPush_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .c)(result, symbolsFunc(object));
}
...
function equalArrays(array, other, bitmask, customizer, equalFunc, stack) {
  ...
  var index = -1,
      result = true,
      seen = (bitmask & COMPARE_UNORDERED_FLAG) ? new _SetCache/* default */.c : undefined;
  ...
  while (++index < arrLength) {
    ...
    if (seen) {
      if (!_arraySome(other, function(othValue, othIndex) {
            if (!(0,_cacheHas/* default */.c)(seen, othIndex) &&
...
var _Uint8Array = __webpack_require__(91392);
// EXTERNAL MODULE: ./node_modules/lodash-es/eq.js
var eq = __webpack_require__(73048);
...
function equalByTag(object, other, tag, bitmask, customizer, equalFunc, stack) {
  switch (tag) {
    ...
    case arrayBufferTag:
      if ((object.byteLength != other.byteLength) ||
          !equalFunc(new _Uint8Array/* default */.c(object), new _Uint8Array/* default */.c(other))) {
        return false;
      }
      return true;
    ...
    case numberTag:
      ...
      return (0,eq/* default */.c)(+object, +other);
    ...
    case setTag:
      ...
      convert || (convert = _setToArray/* default */.c);
...
function equalObjects(object, other, bitmask, customizer, equalFunc, stack) {
  var isPartial = bitmask & _equalObjects_COMPARE_PARTIAL_FLAG,
      objProps = (0,_getAllKeys/* default */.c)(object),
      objLength = objProps.length,
      othProps = (0,_getAllKeys/* default */.c)(other),
...
var isTypedArray = __webpack_require__(93416);
...
function baseIsEqualDeep(object, other, bitmask, customizer, equalFunc, stack) {
  var objIsArr = (0,isArray/* default */.c)(object),
      othIsArr = (0,isArray/* default */.c)(other),
      objTag = objIsArr ? arrayTag : (0,_getTag/* default */.c)(object),
      othTag = othIsArr ? arrayTag : (0,_getTag/* default */.c)(other);
  ...
  if (isSameTag && (0,isBuffer/* default */.c)(object)) {
    if (!(0,isBuffer/* default */.c)(other)) {
      return false;
    }
    objIsArr = true;
    objIsObj = false;
  ...
  if (isSameTag && !objIsObj) {
    stack || (stack = new _Stack/* default */.c);
    return (objIsArr || (0,isTypedArray/* default */.c)(object))
...
function baseIsEqual(value, other, bitmask, customizer, stack) {
  ...
  if (value == null || other == null || (!(0,isObjectLike/* default */.c)(value) && !(0,isObjectLike/* default */.c)(other))) {
...
function baseIsMatch(object, source, matchData, customizer) {
  ...
  while (++index < length) {
    ...
    if (noCustomizer && data[2]) {
      ...
      var stack = new _Stack/* default */.c;
      if (customizer) {
...
function isStrictComparable(value) {
  return value === value && !(0,isObject/* default */.c)(value);
}
...
function getMatchData(object) {
  var result = (0,keys/* default */.c)(object),
...
function get(object, path, defaultValue) {
  var result = object == null ? undefined : (0,_baseGet/* default */.c)(object, path);
...
var hasIn = __webpack_require__(73556);
// EXTERNAL MODULE: ./node_modules/lodash-es/_isKey.js
var _isKey = __webpack_require__(27544);
// EXTERNAL MODULE: ./node_modules/lodash-es/_toKey.js
var _toKey = __webpack_require__(32128);
...
function baseMatchesProperty(path, srcValue) {
  if ((0,_isKey/* default */.c)(path) && _isStrictComparable(srcValue)) {
    return _matchesStrictComparable((0,_toKey/* default */.c)(path), srcValue);
  }
  return function(object) {
    var objValue = lodash_es_get(object, path);
    return (objValue === undefined && objValue === srcValue)
      ? (0,hasIn/* default */.c)(object, path)
...
function basePropertyDeep(path) {
  return function(object) {
    return (0,_baseGet/* default */.c)(object, path);
  };
}
...
function property(path) {
  return (0,_isKey/* default */.c)(path) ? (0,_baseProperty/* default */.c)((0,_toKey/* default */.c)(path)) : _basePropertyDeep(path);
}
...
function baseIteratee(value) {
  ...
  if (value == null) {
    return identity/* default */.c;
  }
  if (typeof value == 'object') {
    return (0,isArray/* default */.c)(value)
...
/* harmony export */   c: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _baseEach_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(92816);
/* harmony import */ var _isArrayLike_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(42440);
...
function baseMap(collection, iteratee) {
  var index = -1,
      result = (0,_isArrayLike_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .c)(collection) ? Array(collection.length) : [];

  (0,_baseEach_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .c)(collection, function(value, key, collection) {
...
/* harmony export */   c: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _identity_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5816);
...
function castFunction(value) {
  return typeof value == 'function' ? value : _identity_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .c;
}
...
var memoize = __webpack_require__(30528);
...
function memoizeCapped(func) {
  var result = (0,memoize/* default */.c)(func, function(key) {
...
var lodash_es_toString = __webpack_require__(90400);
...
function castPath(value, object) {
  if ((0,isArray/* default */.c)(value)) {
    return value;
  }
  return (0,_isKey/* default */.c)(value, object) ? [value] : _stringToPath((0,lodash_es_toString/* default */.c)(value));
}
...
/* harmony export */   c: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _baseGetAllKeys_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(30176);
/* harmony import */ var _getSymbols_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(10772);
/* harmony import */ var _keys_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(62420);
...
function getAllKeys(object) {
  return (0,_baseGetAllKeys_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .c)(object, _keys_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .c, _getSymbols_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .c);
}
...
/* harmony export */   c: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _arrayFilter_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(46091);
/* harmony import */ var _stubArray_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(41716);
 ...
 * @returns {Array} Returns the array of symbols.
 */
var getSymbols = !nativeGetSymbols ? _stubArray_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .c : function(object) {
  if (object == null) {
    return [];
  }
  object = Object(object);
  return (0,_arrayFilter_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .c)(nativeGetSymbols(object), function(symbol) {
...
/* harmony export */ });
/* harmony import */ var _castPath_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(58356);
/* harmony import */ var _isArguments_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(59636);
/* harmony import */ var _isArray_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(78820);
/* harmony import */ var _isIndex_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(748);
/* harmony import */ var _isLength_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(54968);
/* harmony import */ var _toKey_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(32128);
...
function hasPath(object, path, hasFunc) {
  ...
  while (++index < length) {
    var key = (0,_toKey_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .c)(path[index]);
  ...
  return !!length && (0,_isLength_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .c)(length) && (0,_isIndex_js__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .c)(key, length) &&
    ((0,_isArray_js__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .c)(object) || (0,_isArguments_js__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .c)(object));
}
...
function isKey(value, object) {
  if ((0,_isArray_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .c)(value)) {
    return false;
  }
  var type = typeof value;
  if (type == 'number' || type == 'symbol' || type == 'boolean' ||
      value == null || (0,_isSymbol_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .c)(value)) {
    return true;
  }
...
function toKey(value) {
  if (typeof value == 'string' || (0,_isSymbol_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .c)(value)) {
    return value;
  }
  var result = (value + '');
...
/* harmony export */   c: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _baseClone_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(48492);
...
function clone(value) {
  return (0,_baseClone_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .c)(value, CLONE_SYMBOLS_FLAG);
}
...
/* harmony export */   c: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _baseRest_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(34880);
/* harmony import */ var _eq_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(73048);
/* harmony import */ var _isIterateeCall_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(15552);
/* harmony import */ var _keysIn_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(97000);
 ...
 * // => { 'a': 1, 'b': 2 }
 */
var defaults = (0,_baseRest_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .c)(function(object, sources) {
  object = Object(object);
  ...
  if (guard && (0,_isIterateeCall_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .c)(sources[0], sources[1], guard)) {
    length = 1;
  }

  while (++index < length) {
    var source = sources[index];
    var props = (0,_keysIn_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .c)(source);
    var propsIndex = -1;
    ...
    while (++propsIndex < propsLength) {
      ...
      if (value === undefined ||
          ((0,_eq_js__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .c)(value, objectProto[key]) && !hasOwnProperty.call(object, key))) {
...
function baseFilter(collection, predicate) {
  var result = [];
  (0,_baseEach/* default */.c)(collection, function(value, index, collection) {
...
function filter(collection, predicate) {
  var func = (0,isArray/* default */.c)(collection) ? _arrayFilter/* default */.c : _baseFilter;
  return func(collection, (0,_baseIteratee/* default */.c)(predicate, 3));
}
...
/* harmony export */   c: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _baseFlatten_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(62952);
...
function flatten(array) {
  var length = array == null ? 0 : array.length;
  return length ? (0,_baseFlatten_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .c)(array, 1) : [];
}
...
/* harmony export */   c: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _arrayEach_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(56812);
/* harmony import */ var _baseEach_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(92816);
/* harmony import */ var _castFunction_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(12176);
/* harmony import */ var _isArray_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(78820);
...
function forEach(collection, iteratee) {
  var func = (0,_isArray_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .c)(collection) ? _arrayEach_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .c : _baseEach_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .c;
  return func(collection, (0,_castFunction_js__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .c)(iteratee));
}
...
var _hasPath = __webpack_require__(18872);
...
function has(object, path) {
  return object != null && (0,_hasPath/* default */.c)(object, path, _baseHas);
}
...
function hasIn(object, path) {
  return object != null && (0,_hasPath/* default */.c)(object, path, _baseHasIn);
}
...
/* harmony export */   c: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _baseGetTag_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(67724);
/* harmony import */ var _isObjectLike_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(23584);
...
function isSymbol(value) {
  return typeof value == 'symbol' ||
    ((0,_isObjectLike_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .c)(value) && (0,_baseGetTag_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .c)(value) == symbolTag);
}
...
/* harmony export */   c: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _arrayLikeKeys_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(46900);
/* harmony import */ var _baseKeys_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(61376);
/* harmony import */ var _isArrayLike_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(42440);
...
function keys(object) {
  return (0,_isArrayLike_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .c)(object) ? (0,_arrayLikeKeys_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .c)(object) : (0,_baseKeys_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .c)(object);
}
...
/* harmony export */   c: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _arrayMap_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1304);
/* harmony import */ var _baseIteratee_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(91312);
/* harmony import */ var _baseMap_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(90360);
/* harmony import */ var _isArray_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(78820);
...
function map(collection, iteratee) {
  var func = (0,_isArray_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .c)(collection) ? _arrayMap_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .c : _baseMap_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .c;
  return func(collection, (0,_baseIteratee_js__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .c)(iteratee, 3));
}
...
var _castPath = __webpack_require__(58356);
// EXTERNAL MODULE: ./node_modules/lodash-es/_isIndex.js
var _isIndex = __webpack_require__(748);
// EXTERNAL MODULE: ./node_modules/lodash-es/isObject.js
var isObject = __webpack_require__(5368);
// EXTERNAL MODULE: ./node_modules/lodash-es/_toKey.js
var _toKey = __webpack_require__(32128);
...
function baseSet(object, path, value, customizer) {
  if (!(0,isObject/* default */.c)(object)) {
    return object;
  }
  path = (0,_castPath/* default */.c)(path, object);
  ...
  while (nested != null && ++index < length) {
    var key = (0,_toKey/* default */.c)(path[index]),
        newValue = value;
    ...
    if (index != lastIndex) {
      ...
      if (newValue === undefined) {
        newValue = (0,isObject/* default */.c)(objValue)
          ? objValue
          : ((0,_isIndex/* default */.c)(path[index + 1]) ? [] : {});
      }
    }
    (0,_assignValue/* default */.c)(nested, key, newValue);
    nested = nested[key];
  }
  return object;
}
...
function basePickBy(object, paths, predicate) {
  ...
  while (++index < length) {
    var path = paths[index],
        value = (0,_baseGet/* default */.c)(object, path);

    if (predicate(value, path)) {
      _baseSet(result, (0,_castPath/* default */.c)(path, object), value);
    }
  }
  return result;
}
...
function basePick(object, paths) {
  return _basePickBy(object, paths, function(value, path) {
    return (0,hasIn/* default */.c)(object, path);
  });
}
...
var _overRest = __webpack_require__(10648);
// EXTERNAL MODULE: ./node_modules/lodash-es/_setToString.js + 2 modules
var _setToString = __webpack_require__(99669);
...
function flatRest(func) {
  return (0,_setToString/* default */.c)((0,_overRest/* default */.c)(func, undefined, flatten/* default */.c), func + '');
}
...
function createRange(fromRight) {
  return function(start, end, step) {
    if (step && typeof step != 'number' && (0,_isIterateeCall/* default */.c)(start, end, step)) {
      end = step = undefined;
    }
    // Ensure the sign of `-0` is preserved.
    start = (0,toFinite/* default */.c)(start);
    if (end === undefined) {
      end = start;
      start = 0;
    } else {
      end = (0,toFinite/* default */.c)(end);
    }
    step = step === undefined ? (start < end ? 1 : -1) : (0,toFinite/* default */.c)(step);
...
function reduce(collection, iteratee, accumulator) {
  ...
  return func(collection, (0,_baseIteratee/* default */.c)(iteratee, 4), accumulator, initAccum, _baseEach/* default */.c);
}
...
function toNumber(value) {
  ...
  if ((0,isSymbol/* default */.c)(value)) {
    return NAN;
  }
  if ((0,isObject/* default */.c)(value)) {
    var other = typeof value.valueOf == 'function' ? value.valueOf() : value;
    value = (0,isObject/* default */.c)(other) ? (other + '') : other;
  }
...
function baseToString(value) {
  ...
  if ((0,isArray/* default */.c)(value)) {
    ...
    return (0,_arrayMap/* default */.c)(value, baseToString) + '';
  }
  if ((0,isSymbol/* default */.c)(value)) {
...
/* harmony export */   c: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _toString_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(90400);
...
function uniqueId(prefix) {
  var id = ++idCounter;
  return (0,_toString_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .c)(prefix) + id;
}
...
function baseValues(object, props) {
  return (0,_arrayMap/* default */.c)(props, function(key) {
    return object[key];
  });
}
...
function values(object) {
  return object == null ? [] : _baseValues(object, (0,keys/* default */.c)(object));
}
...
var mermaid_f47111a7 = __webpack_require__(74363);
...
var esm = __webpack_require__(71408);
...
function preprocessMarkdown(markdown) {
  ...
  const withoutExtraSpaces = (0,esm/* dedent */.s)(withoutMultipleNewlines);
...
/* harmony export */ });
/* harmony import */ var _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(74363);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(37352);
/* harmony import */ var _createText_6b48ae7d_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(42692);
...
function addHtmlLabel(node) {
  const fo = (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .select */ .MlD)(document.createElementNS("http://www.w3.org/2000/svg", "foreignObject"));
  const div = fo.append("xhtml:div");
  const label = node.label;
  const labelClass = node.isNode ? "nodeLabel" : "edgeLabel";
  div.html(
...
const labelHelper = async (parent, node, _classes, isNode) => {
  ...
  if ((0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_1__.m)((0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_1__.c)().flowchart.htmlLabels)) {
    ...
    const dv = (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .select */ .MlD)(text);
...
const rectWithTitle = (parent, node) => {
  ...
  if ((0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_1__.m)((0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_1__.c)().flowchart.htmlLabels)) {
    ...
    const dv = (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .select */ .MlD)(descr);
    bbox = div.getBoundingClientRect();
    dv.attr("width", bbox.width);
    dv.attr("height", bbox.height);
  }
  const halfPadding = node.padding / 2;
  (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .select */ .MlD)(descr).attr(
    "transform",
    "translate( " + // (titleBox.width - bbox.width) / 2 +
    (bbox.width > titleBox.width ? 0 : (titleBox.width - bbox.width) / 2) + ", " + (titleBox.height + halfPadding + 5) + ")"
  );
  (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .select */ .MlD)(text).attr(
    "transform",
    "translate( " + // (titleBox.width - bbox.width) / 2 +
...
const class_box = (parent, node) => {
  ...
  if ((0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_1__.m)((0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_1__.c)().flowchart.htmlLabels)) {
    ...
    const dv = (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .select */ .MlD)(interfaceLabel);
  ...
  (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .select */ .MlD)(classTitleLabel).attr("class", "classTitle");
  let classTitleBBox = classTitleLabel.getBBox();
  if ((0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_1__.m)((0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_1__.c)().flowchart.htmlLabels)) {
    const div = classTitleLabel.children[0];
    const dv = (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .select */ .MlD)(classTitleLabel);
  ...
  node.classData.members.forEach((member) => {
    ...
    if ((0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_1__.m)((0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_1__.c)().flowchart.htmlLabels)) {
      ...
      const dv = (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .select */ .MlD)(lbl);
      bbox = div.getBoundingClientRect();
      dv.attr("width", bbox.width);
      dv.attr("height", bbox.height);
    }
  ...
  if (hasInterface) {
    ...
    (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .select */ .MlD)(interfaceLabel).attr(
      "transform",
  ...
  (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .select */ .MlD)(classTitleLabel).attr(
    "transform",
  ...
  classAttributes.forEach((lbl) => {
    (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .select */ .MlD)(lbl).attr(
      "transform",
...
const insertEdgeLabel = (elem, edge) => {
  ...
  if (useHtmlLabels) {
    ...
    const dv = (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .select */ .MlD)(labelElement);
    bbox = div.getBoundingClientRect();
    dv.attr("width", bbox.width);
    dv.attr("height", bbox.height);
  }
...
const insertEdge = function(elem, e, edge, clusterDb, diagramType, graph, id) {
  ...
  let curve = d3__WEBPACK_IMPORTED_MODULE_0__/* .curveBasis */ .k7;
  if (edge.curve && (diagramType === "graph" || diagramType === "flowchart")) {
    curve = edge.curve;
  }
  const { x, y } = getLineFunctionsWithOffset(edge);
  const lineFunction = (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .line */ .cFK)().x(x).y(y).curve(curve);
  let strokeClasses;
...
const setupToolTips = function(element) {
  let tooltipElem = (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .select */ .MlD)(".mermaidTooltip");
  if ((tooltipElem._groups || tooltipElem)[0][0] === null) {
    tooltipElem = (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .select */ .MlD)("body").append("div").attr("class", "mermaidTooltip").style("opacity", 0);
  }
  const svg = (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .select */ .MlD)(element).select("svg");
  const nodes = svg.selectAll("g.node");
  nodes.on("mouseover", function() {
    const el = (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .select */ .MlD)(this);
...
var flowDb_4b19a42f = __webpack_require__(93832);
// EXTERNAL MODULE: ./node_modules/dagre-d3-es/src/graphlib/index.js
var graphlib = __webpack_require__(95536);
// EXTERNAL MODULE: ./node_modules/d3/src/index.js + 197 modules
var src = __webpack_require__(37352);
// EXTERNAL MODULE: ./node_modules/mermaid/dist/mermaid-f47111a7.js + 8 modules
var mermaid_f47111a7 = __webpack_require__(74363);
// EXTERNAL MODULE: ./node_modules/lodash-es/has.js + 1 modules
var has = __webpack_require__(7248);
...
var dagre = __webpack_require__(32304);
// EXTERNAL MODULE: ./node_modules/dagre-d3-es/src/dagre-js/util.js
var util = __webpack_require__(14620);
...
function normal(parent, id, edge, type) {
  ...
  util/* applyStyle */.Ce(path, edge[type + 'Style']);
  if (edge[type + 'Class']) {
...
var add_html_label = __webpack_require__(53128);
...
function addSVGLabel(root, node) {
  ...
  util/* applyStyle */.Ce(domNode, node.labelStyle);
...
function addLabel(root, node, location) {
  ...
  if (node.labelType === 'svg') {
    ...
    (0,add_html_label/* addHtmlLabel */.m)(labelSvg, node);
  } else {
...
var createClusters = function (selection, g) {
  var clusters = g.nodes().filter(function (v) {
    return util/* isSubgraph */.cv(g, v);
  });
  var svgClusters = selection.selectAll('g.cluster').data(clusters, function (v) {
    return v;
  });

  util/* applyTransition */.q2(svgClusters.exit(), g).style('opacity', 0).remove();
  ...
  var enterSelection = svgClusters
    ...
    .each(function (v) {
      var node = g.node(v);
      var thisGroup = src/* select */.MlD(this);
      src/* select */.MlD(this).append('rect');
  ...
  svgClusters = util/* applyTransition */.q2(svgClusters, g).style('opacity', 1);

  svgClusters.selectAll('rect').each(function (c) {
    var node = g.node(c);
    var domCluster = src/* select */.MlD(this);
    util/* applyStyle */.Ce(domCluster, node.style);
  });
...
let createEdgeLabels = function (selection, g) {
  ...
  svgEdgeLabels.each(function (e) {
    ...
    if (!has/* default */.c(edge, 'width')) {
      edge.width = bbox.width;
    }
    if (!has/* default */.c(edge, 'height')) {
      edge.height = bbox.height;
    }
  });
  ...
  util/* applyTransition */.q2(exitSelection, g).style('opacity', 0).remove();
...
var createEdgePaths = function (selection, g, arrows) {
  ...
  util/* applyTransition */.q2(svgPaths, g).style('opacity', 1);

  // Save DOM element in the path group, and set ID and class
  svgPaths.each(function (e) {
    var domEdge = src/* select */.MlD(this);
    var edge = g.edge(e);
    edge.elem = this;
  ...
  svgPaths.selectAll('path.path').each(function (e) {
    var edge = g.edge(e);
    edge.arrowheadId = uniqueId/* default */.c('arrowhead');
    ...
    util/* applyTransition */.q2(domEdge, g).attr('d', function (e) {
      return calcPoints(g, e);
    });

    util/* applyStyle */.Ce(domEdge, edge.style);
  });
  ...
  svgPaths.selectAll('defs').each(function (e) {
    ...
    arrowhead(src/* select */.MlD(this), edge.arrowheadId, edge, 'arrowhead');
  });
...
function createLine(edge, points) {
  // @ts-expect-error
  var line = (src/* line */.cFK || src/* svg */.WWK.line)()
    .x(function (d) {
      return d.x;
    })
    .y(function (d) {
...
function enter(svgPaths, g) {
  ...
  svgPathsEnter
    ...
    .attr('d', function (e) {
      ...
      var points = range/* default */.c(edge.points.length).map(function () {
...
function exit(svgPaths, g) {
  ...
  util/* applyTransition */.q2(svgPathExit, g).style('opacity', 0).remove();
}
...
var createNodes = function (selection, g, shapes) {
  ...
  svgNodes.each(function (v) {
    ...
    var bbox = pick/* default */.c(labelDom.node().getBBox(), 'width', 'height');
    ...
    if (has/* default */.c(node, 'width')) {
      bbox.width = node.width;
    }
    if (has/* default */.c(node, 'height')) {
    ...
    util/* applyStyle */.Ce(shapeSvg, node.style);
...
function positionClusters(selection, g) {
  var created = selection.filter(function () {
    return !src/* select */.MlD(this).classed('update');
  });
  ...
  util/* applyTransition */.q2(selection, g).style('opacity', 1).attr('transform', translate);

  util/* applyTransition */.q2(created.selectAll('rect'), g)
...
function positionEdgeLabels(selection, g) {
  ...
  function translate(e) {
    var edge = g.edge(e);
    return has/* default */.c(edge, 'x') ? 'translate(' + edge.x + ',' + edge.y + ')' : '';
  }
...
var EDGE_DEFAULT_ATTRS = {
  arrowhead: 'normal',
  curve: src/* curveLinear */.qGi,
};

function preProcessGraph(g) {
  g.nodes().forEach(function (v) {
    var node = g.node(v);
    if (!has/* default */.c(node, 'label') && !g.children(v).length) {
      node.label = v;
    }

    if (has/* default */.c(node, 'paddingX')) {
      defaults/* default */.c(node, {
        paddingLeft: node.paddingX,
        paddingRight: node.paddingX,
      });
    }

    if (has/* default */.c(node, 'paddingY')) {
      defaults/* default */.c(node, {
    ...
    defaults/* default */.c(node, NODE_DEFAULT_ATTRS);

    forEach/* default */.c(['paddingLeft', 'paddingRight', 'paddingTop', 'paddingBottom'], function (k) {
  ...
  g.edges().forEach(function (e) {
    var edge = g.edge(e);
    if (!has/* default */.c(edge, 'label')) {
      edge.label = '';
    }
    defaults/* default */.c(edge, EDGE_DEFAULT_ATTRS);
  });
}
...
function postProcessGraph(g) {
  forEach/* default */.c(g.nodes(), function (v) {
    ...
    if (has/* default */.c(node, '_prevWidth')) {
      node.width = node._prevWidth;
    } else {
      delete node.width;
    }

    if (has/* default */.c(node, '_prevHeight')) {
...
const addVertices = async function(vert, g, svgId, root, _doc, diagObj) {
  const svg = !root ? (0,src/* select */.MlD)(`[id="${svgId}"]`) : root.select(`[id="${svgId}"]`);
  ...
  for (const id of keys) {
    ...
    if ((0,mermaid_f47111a7.m)((0,mermaid_f47111a7.c)().flowchart.htmlLabels)) {
      ...
      vertexNode = (0,add_html_label/* addHtmlLabel */.m)(svg, node).node();
...
const addEdges = async function(edges, g, diagObj) {
  ...
  for (const edge of edges) {
    ...
    if (edge.interpolate !== void 0) {
      edgeData.curve = (0,mermaid_f47111a7.n)(edge.interpolate, src/* curveLinear */.qGi);
    } else if (edges.defaultInterpolate !== void 0) {
      edgeData.curve = (0,mermaid_f47111a7.n)(edges.defaultInterpolate, src/* curveLinear */.qGi);
    } else {
      edgeData.curve = (0,mermaid_f47111a7.n)(conf.curve, src/* curveLinear */.qGi);
    }
    if (edge.text === void 0) {
      if (edge.style !== void 0) {
      ...
      if ((0,mermaid_f47111a7.m)((0,mermaid_f47111a7.c)().flowchart.htmlLabels)) {
        ...
        edgeData.label = `<span id="L-${linkId}" class="edgeLabel L-${linkNameStart}' L-${linkNameEnd}" style="${edgeData.labelStyle}">${await (0,mermaid_f47111a7.r)(
          edge.text.replace(
            /fa[blrs]?:fa-[\w-]+/g,
            // cspell:disable-line
            (s) => `<i class='${s.replace(":", " ")}'></i>`
...
const draw = async function(text, id, _version, diagObj) {
  ...
  if (securityLevel === "sandbox") {
    sandboxElement = (0,src/* select */.MlD)("#i" + id);
  }
  const root = securityLevel === "sandbox" ? (0,src/* select */.MlD)(sandboxElement.nodes()[0].contentDocument.body) : (0,src/* select */.MlD)("body");
  ...
  for (i = subGraphs.length - 1; i >= 0; i--) {
    subG = subGraphs[i];
    (0,src/* selectAll */.COP)("cluster").append("text");
  ...
  render$1.arrows().none = function normal(parent, id2, edge, type) {
    ...
    (0,util/* applyStyle */.Ce)(path, edge[type + "Style"]);
  };
  ...
  for (i = 0; i < subGraphs.length; i++) {
    ...
    if (subG.title !== "undefined") {
      ...
      const cluster = (0,src/* select */.MlD)(clusterEl[0]);
...
/* harmony export */ });
/* harmony import */ var dagre_d3_es_src_dagre_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(32304);
/* harmony import */ var dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(41520);
/* harmony import */ var _edges_d32062c0_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(22200);
/* harmony import */ var _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(74363);
/* harmony import */ var dagre_d3_es_src_graphlib_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(95536);
/* harmony import */ var _createText_6b48ae7d_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(42692);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(37352);
...
const adjustClustersAndEdges = (graph, depth) => {
  ...
  _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Adjusted Graph", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .G(graph));
  extractor(graph, 0);
  _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.l.trace(clusterDb);
};
const extractor = (graph, depth) => {
  _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("extractor - ", depth, dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .G(graph), graph.children("D"));
  if (depth > 10) {
  ...
  for (const node of nodes) {
    ...
    graph.children(node) && graph.children(node).length > 0) {
      ...
      const clusterGraph = new dagre_d3_es_src_graphlib_index_js__WEBPACK_IMPORTED_MODULE_2__/* .Graph */ .M({
        multigraph: true,
        compound: true
      }).setGraph({
        rankdir: dir,
      ...
      _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Old graph before copy", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .G(graph));
      ...
      _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("New graph after copy node: (", node, ")", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .G(clusterGraph));
      _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Old graph after copy", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .G(graph));
    } else {
      _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.l.warn(
        "Cluster ** ",
        node,
...
const rect = (parent, node) => {
  ...
  if ((0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.m)(siteConfig.flowchart.htmlLabels)) {
    const div = text.children[0];
    const dv = (0,d3__WEBPACK_IMPORTED_MODULE_3__/* .select */ .MlD)(text);
    bbox = div.getBoundingClientRect();
    dv.attr("width", bbox.width);
    dv.attr("height", bbox.height);
  }
...
const recursiveRender = async (_elem, graph, diagramType, id, parentCluster, siteConfig) => {
  _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Graph in recursive render: XXX", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .G(graph), parentCluster);
  ...
  (0,dagre_d3_es_src_dagre_index_js__WEBPACK_IMPORTED_MODULE_0__/* .layout */ .cn)(graph);
  _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Graph after layout:", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .G(graph));
  let diff = 0;
...
const render = async (elem, graph, markers, diagramType, id) => {
  ...
  clear();
  clear$1();
  _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Graph at first:", JSON.stringify(dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .G(graph)));
  adjustClustersAndEdges(graph);
  _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Graph after:", JSON.stringify(dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__/* .write */ .G(graph)));
  const siteConfig = (0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_4__.c)();
...
/* harmony export */ });
/* harmony import */ var dagre_d3_es_src_graphlib_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(95536);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(37352);
/* harmony import */ var _mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(74363);
/* harmony import */ var _index_fc10efb0_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(23176);
/* harmony import */ var dagre_d3_es_src_dagre_js_label_add_html_label_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(53128);
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(21048);
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(19837);
  ...
  for (const id of keys) {
    ...
    if (vertex.labelType === "markdown") {
      ...
      if ((0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_2__.m)((0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_2__.c)().flowchart.htmlLabels)) {
        ...
        vertexNode = (0,dagre_d3_es_src_dagre_js_label_add_html_label_js__WEBPACK_IMPORTED_MODULE_3__/* .addHtmlLabel */ .m)(svg, node).node();
        vertexNode.parentNode.removeChild(vertexNode);
      } else {
        const svgLabel = doc.createElementNS("http://www.w3.org/2000/svg", "text");
        svgLabel.setAttribute("style", styles.labelStyle.replace("color:", "fill:"));
...
const addEdges = async function(edges, g, diagObj) {
  ...
  for (const edge of edges) {
    ...
    if (edge.interpolate !== void 0) {
      edgeData.curve = (0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_2__.n)(edge.interpolate, d3__WEBPACK_IMPORTED_MODULE_1__/* .curveLinear */ .qGi);
    } else if (edges.defaultInterpolate !== void 0) {
      edgeData.curve = (0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_2__.n)(edges.defaultInterpolate, d3__WEBPACK_IMPORTED_MODULE_1__/* .curveLinear */ .qGi);
    } else {
      edgeData.curve = (0,_mermaid_f47111a7_js__WEBPACK_IMPORTED_MODULE_2__.n)(conf.curve, d3__WEBPACK_IMPORTED_MODULE_1__/* .curveLinear */ .qGi);
    }
    if (edge.text === void 0) {
      if (edge.style !== void 0) {
        edgeData.arrowheadStyle = "fill: #333";
...
const draw = async function(text, id, _version, diagObj) {
  ...
  let sandboxElement;
  if (securityLevel === "sandbox") {
    sandboxElement = (0,d3__WEBPACK_IMPORTED_MODULE_1__/* .select */ .MlD)("#i" + id);
  }
  const root = securityLevel === "sandbox" ? (0,d3__WEBPACK_IMPORTED_MODULE_1__/* .select */ .MlD)(sandboxElement.nodes()[0].contentDocument.body) : (0,d3__WEBPACK_IMPORTED_MODULE_1__/* .select */ .MlD)("body");
  const doc = securityLevel === "sandbox" ? sandboxElement.nodes()[0].contentDocument : document;
  const g = new dagre_d3_es_src_graphlib_index_js__WEBPACK_IMPORTED_MODULE_0__/* .Graph */ .M({
    multigraph: true,
    compound: true
  }).setGraph({
    rankdir: dir,
  ...
  for (i = subGraphs.length - 1; i >= 0; i--) {
    subG = subGraphs[i];
    (0,d3__WEBPACK_IMPORTED_MODULE_1__/* .selectAll */ .COP)("cluster").append("text");
    for (let j = 0; j < subG.nodes.length; j++) {
  ...
  keys.forEach(function(key) {
    const vertex = vert[key];
    if (vertex.link) {
      const node = (0,d3__WEBPACK_IMPORTED_MODULE_1__/* .select */ .MlD)("#" + id + ' [id="' + key + '"]');
      if (node) {
        const link = doc.createElementNS("http://www.w3.org/2000/svg", "a");
        link.setAttributeNS("http://www.w3.org/2000/svg", "class", vertex.classes.join(" "));
        link.setAttributeNS("http://www.w3.org/2000/svg", "href", vertex.link);
...
const fade = (color, opacity) => {
  const channel = khroma__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .c;
  const r = channel(color, "r");
  const g = channel(color, "g");
  const b = channel(color, "b");
  return khroma__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .c(r, g, b, opacity);
};
